...
use super::{CalculateReceiptRootError, PexeChain, RewardPolicy};
use crate::{
    BuildIdentityHasher, MemoryLocation, PexeTxExecutionResult, TxIdx, hash_deterministic,
    mv_memory::MvMemory,
};

/// Implementation of [`PexeChain`] for Ethereum
...
impl PexeChain for PevmEthereum {
    ...
    fn calculate_receipt_root(
        ...
        tx_results: &[PexeTxExecutionResult],
