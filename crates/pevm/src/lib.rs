...
// PerpDex module for parallel orderbook execution
pub mod perpdex;

// Hybrid block execution support
pub mod hybrid;
...
mod mv_memory;
mod pexe;
pub use pexe::{Pexe, PexeError, PexeResult, execute_revm_sequential};
mod scheduler;
mod storage;
pub use storage::{
...
mod vm;
pub use vm::{ExecutionError, PexeTxExecutionResult};
